...
Task 2:
create a delete button beside each row of cookie domain, when click, it deletes the cookies on that domain and refresh the cookie table. Go to website button
Task 3: 
